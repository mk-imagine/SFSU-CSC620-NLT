...
pairs = (
    ...
    (
        r"(.*)(finals?|exams?|tests?|quiz(zes)?|homework|projects?|assignments?)(.*)",
        (
    ...
    (
        r"(.*)(computer science|math(ematics|s)?)(.*)",
        (
    ...
    (
        r"(.*)(grades|scores)(.*)",
        (
            "How do your %2 make you feel?",
            "What do you think you can do to improve your %2?",
            "How important are your %2 to you?",
            "What do you think good %2 will allow you to do?"
        ),
    ),
    (
        r"(.*)(job|career)(.*)",
